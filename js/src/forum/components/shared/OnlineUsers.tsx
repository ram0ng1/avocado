  ...
  view() {
    ...
    return (
      <div className={wrapperClass}>
        ...
        {app.forum?.attribute('avocadoShowOnlineCount') !== false && <span className="AvocadoHome-onlineAvatars-count">{total} {app.translator.trans('ramon-avocado.forum.online_users.online')}</span>}
      </div>
    );
  }
